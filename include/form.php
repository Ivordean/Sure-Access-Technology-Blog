...
$recaptcha_secret = 'Confirm if you are a human being'; // Your reCaptcha Secret
...
$hcaptcha_secret = 'Lets check if you are human'; // Your hCaptcha Secret
...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
	...
	$ar_footer	= !empty( $submits['ar_footer'] ) ? $submits['ar_footer'] : 'Copyrights &copy; ' . date('2023') . ' <strong>SemiColonWeb</strong>. All Rights Reserved.';
